...
Deps: pip install pandas numpy matplotlib scipy openpyxl
"""
...
class EventPickerApp:
    ...
    def detect_roi(self, roi):
        ...
        # Decay tau: time from peak to 1/e crossing (already computed above as t_tau).
        tau = (t_tau - tpk) if t_tau is not None else None
